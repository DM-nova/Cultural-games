...
public class FollowJpoints : MonoBehaviour
{
    ...
    public void p5click()
    {
        LeanTween.scale(l3,new Vector3(0.0330126f,0.1407386f,0f),0.2f).setDelay(0f);
    }
    ...
    public void b5click()
    {
        LeanTween.scale(bl3,new Vector3(0.0330126f,0.1407386f,0f),0.2f).setDelay(0f);
    }
   ...
   public void y5click()
    {
        LeanTween.scale(yl3,new Vector3(0.0330126f,0.1407386f,0f),0.2f).setDelay(0f);
    }
