...
public class bFollowArabic : MonoBehaviour
{
    ...
    {     
          ...
          LeanTween.scale(b5,new Vector3(0.04629767f,0.1016601f,0f),0.5f).setDelay(0.5f);
    }
    public void b5click()
    {     
          LeanTween.scale(b5_1,new Vector3(0.04845408f,0.08137748f,0f),0f).setDelay(0f);
    ...
    public void y5click()
    {     
          LeanTween.scale(y5_1,new Vector3(0.04730349f,0.07870262f,0f),0f).setDelay(0f);
