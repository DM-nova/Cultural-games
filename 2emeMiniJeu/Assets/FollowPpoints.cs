...
public class FollowPpoints : MonoBehaviour
{
    ...
    {
        LeanTween.scale(p1,new Vector3(0.03541376f,0.06388213f,0.5f),0f).setDelay(0f).setEase(LeanTweenType.easeOutElastic);
    }
     public void p1click()
    {
          LeanTween.scale(p2,new Vector3(0.03541376f,0.06113451f,0f),0f).setDelay(0f);
    }
    public void p2click()
    {  
        LeanTween.scale(l1,new Vector3(0.242888f,0.05375f,0f),0f).setDelay(0f);
        LeanTween.scale(p3,new Vector3(0.03419614f,0.08166889f,0f),0.5f).setDelay(0.5f);

    }
    public void p3click()
    {
        LeanTween.scale(l2,new Vector3(0.1187091f,0.151682f,0f),0f).setDelay(0f);
        LeanTween.scale(p4,new Vector3(0.03570882f,0.07618906f,0f),0.5f).setDelay(0.5f);
    }
    public void p4click()
    {
