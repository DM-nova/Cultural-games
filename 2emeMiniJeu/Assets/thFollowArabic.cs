...
public class thFollowArabic : MonoBehaviour
{
    [SerializeField] GameObject p1,p2,p3,p4,p5,p5_1,p6,p6_1,p7,p7_1;
    [SerializeField] GameObject l1,l2,l3;

    [SerializeField] GameObject b1,b2,b3,b4,b5,b5_1,b6,b6_1,b7,b7_1;
    [SerializeField] GameObject bl1,bl2,bl3;

    [SerializeField] GameObject y1,y2,y3,y4,y5,y5_1,y6,y6_1,y7,y7_1;
    ...
    {     
          ...
          LeanTween.scale(p7,new Vector3(0.027871f,0.07489026f,0f),0.5f).setDelay(0.5f);
          
    }
    public void p7click()
    {     
          LeanTween.scale(p7_1,new Vector3(0.027871f,0.05897608f,0f),0f).setDelay(0f);
       ...
       public void aaRemoveAll()
     {
        LeanTween.scale(p1,new Vector3(0f,0f,0f),0f);
         ...
         LeanTween.scale(p7_1,new Vector3(0f,0f,0f),0f);
    ...
    {     
          ...
          LeanTween.scale(b7,new Vector3(0.04790328f,0.09361283f,0f),0.5f).setDelay(0.5f);
          
    }
    public void b7click()
    {     
          LeanTween.scale(b7_1,new Vector3(0.0475549f,0.07127813f,0f),0f).setDelay(0f);
       ...
       public void aaBRemoveAll()
     {
        LeanTween.scale(b1,new Vector3(0f,0f,0f),0f);
         ...
         LeanTween.scale(b7_1,new Vector3(0f,0f,0f),0f);
    ...
    {     
          ...
          LeanTween.scale(y7,new Vector3(0.04790328f,0.09361283f,0f),0.5f).setDelay(0.5f);
          
    }
    public void y7click()
    {     
          LeanTween.scale(y7_1,new Vector3(0.0475549f,0.07127813f,0f),0f).setDelay(0f);
       ...
       public void aaYRemoveAll()
     {
        LeanTween.scale(y1,new Vector3(0f,0f,0f),0f);
         ...
         LeanTween.scale(y7_1,new Vector3(0f,0f,0f),0f);
