...
public class      DHA1FollowArabic : MonoBehaviour 
{
   [SerializeField] GameObject p1,p2,p3,p4,p5,p6,p6_1;
    ...
    {     
          ...
          LeanTween.scale(p6,new Vector3(0.02259113f,0.04688064f,0f),0.5f).setDelay(0.5f);
   }
    public void p6click()
    {     
          LeanTween.scale(p6_1,new Vector3(0.0218734f,0.04139685f,0f),0f).setDelay(0f);
    }
    ...
    {     
        ...
        LeanTween.scale(b6,new Vector3(0.02648881f,0.0495537f,0f),0.5f).setDelay(0.5f);
   }
    public void b6click()
    {     
          LeanTween.scale(b6_1,new Vector3(0.02648881f,0.0495537f,0f),0f).setDelay(0f);
    }
     ...
     public void arabAyellowColor()
   {
    ...
    {     
       ...
       LeanTween.scale(y6,new Vector3(0.02648881f,0.0495537f,0f),0.5f).setDelay(0.5f);
   }
    public void y6click()
    {     
          LeanTween.scale(y6_1,new Vector3(0.02648881f,0.0495537f,0f),0f).setDelay(0f);
    }
