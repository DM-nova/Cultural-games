...
public class DHA2FollowArabic : MonoBehaviour 
{
   [SerializeField] GameObject p1,p2,p3,p4,p5,p6,p6_1;
    ...
    LeanTween.scale(p6,new Vector3(0.02129263f,0.05064465f,0f),0.5f).setDelay(0.5f);
    }
     public void p6click()
    {
LeanTween.scale(p6_1,new Vector3(0.02315169f,0.04415108f,0f),0.5f).setDelay(0.5f);
    }
    ...
    {     
        ...
        LeanTween.scale(b6,new Vector3(0.03164027f,0.07525655f,0f),0.5f).setDelay(0.5f);
    }
     public void b6click()
    {
LeanTween.scale(b6_1,new Vector3(0.03440278f,0.06560728f,0f),0.5f).setDelay(0.5f);
    }
     ...
     public void arabAyellowColor()
   {
    ...
    {     
          ...
          LeanTween.scale(y6,new Vector3(0.03164027f,0.07525655f,0f),0.5f).setDelay(0.5f);
    }
     public void y6click()
    {
LeanTween.scale(y6_1,new Vector3(0.03440278f,0.06560728f,0f),0.5f).setDelay(0.5f);
    }
