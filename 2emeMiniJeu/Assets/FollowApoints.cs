...
public class FollowAPoints : MonoBehaviour
{
   ...
   // public List<GameObject> Lines=new List<GameObject>();
    ...
    public void RedColor()
    {
     ...
     {  LeanTween.scale(Line1,new Vector3(0.106875f,0.026625f,0f),0f).setDelay(2f);
     ...
     {   LeanTween.scale(Line2,new Vector3(0.106875f,0.026625f),0f).setDelay(2f);
         LeanTween.scale(point4,new Vector3(0.04396641f,0.1062951f,0f),1f).setDelay(0f);
     }
     public void point4click()
     {
        LeanTween.scale(Line3,new Vector3(0.106875f,0.026625f,0f),0f).setDelay(2f);
        LeanTween.scale(point5,new Vector3(0.05f,0.1f,0f),1f).setDelay(0f);

     }
     public void point5click()
     {
         LeanTween.scale(point6,new Vector3(0.05f,0.1f,0f),0f).setDelay(1f)/*.setOnComplete(RemoveAll)*/;
     }
...
/****************************************************************************************/
      ...
      public void BlueColor()
    {
     ...
     {  LeanTween.scale(blueLine1,new Vector3(0.106875f,0.026625f,0f),0f).setDelay(2f);
     ...
     {   LeanTween.scale(blueLine2,new Vector3(0.106875f,0.026625f),0f).setDelay(2f);
         LeanTween.scale(blue4,new Vector3(0.04396641f,0.1062951f,0f),1f).setDelay(0f);
     }
     public void bpoint4click()
     {
        LeanTween.scale(blueLine3,new Vector3(0.106875f,0.026625f,0f),0f).setDelay(2f);
        LeanTween.scale(blue5,new Vector3(0.05f,0.1f,0f),1f).setDelay(0f);

     }
     public void bpoint5click()
     {
         LeanTween.scale(blue6,new Vector3(0.05f,0.1f,0f),0f).setDelay(1f)/*.setOnComplete(RemoveAll)*/;
     }
    ...
    public void YellowColor()
     ...
     {  LeanTween.scale(yellowLine1,new Vector3(0.106875f,0.026625f,0f),0f).setDelay(2f);
     ...
     {   LeanTween.scale(yellowLine2,new Vector3(0.106875f,0.026625f),0f).setDelay(2f);
         LeanTween.scale(yellow4,new Vector3(0.04396641f,0.1062951f,0f),1f).setDelay(0f);
     }
     public void ypoint4click()
     {
        LeanTween.scale(yellowLine3,new Vector3(0.106875f,0.026625f,0f),0f).setDelay(2f);
        LeanTween.scale(yellow5,new Vector3(0.05f,0.1f,0f),1f).setDelay(0f);

     }
     public void ypoint5click()
     {
         LeanTween.scale(yellow6,new Vector3(0.05f,0.1f,0f),0f).setDelay(1f)/*.setOnComplete(RemoveAll)*/;
     }
