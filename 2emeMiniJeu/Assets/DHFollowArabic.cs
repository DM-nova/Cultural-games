...
public class DHFollowArabic : MonoBehaviour 
{
   [SerializeField] GameObject p1,p2,p3,p4,p5,p5_1;
    ...
    LeanTween.scale(p5,new Vector3(0.02439321f,0.05125753f,0f),0.5f).setDelay(0.5f);
    }
    public void p5click()
    {
       LeanTween.scale(p5_1,new Vector3(0.02653515f,0.05575838f,0f),0.5f).setDelay(0.5f);
    }
    ...
    {     
      ...
      LeanTween.scale(b5,new Vector3(0.03995655f,0.08396082f,0f),0.5f).setDelay(0.5f);
    }
    public void b5click()
    {
       LeanTween.scale(b5_1,new Vector3(0.03995655f,0.08396082f,0f),0.5f).setDelay(0.5f);
    }
    ...
    {     
          LeanTween.scale(yl3,new Vector3(0.08872249f,0.1923262f,0f),0f).setDelay(0f);
           LeanTween.scale(y5,new Vector3(0.03995655f,0.08396082f,0f),0.5f).setDelay(0.5f);
    }
    public void y5click()
    {
       LeanTween.scale(y5_1,new Vector3(0.03995655f,0.08396082f,0f),0.5f).setDelay(0.5f);
    }
